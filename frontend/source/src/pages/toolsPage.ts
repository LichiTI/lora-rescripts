...
export function renderToolsPage() {
  return `
    ${createPageHero(
      "tools",
      "Tools launcher migration page",
      "This route now reaches into the real script launcher boundary, which is exactly where the new source workspace starts touching core behavior."
    )}
