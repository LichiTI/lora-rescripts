Schema.intersect([
    Schema.object({
        interrogator_model: Schema.union(["cl_tagger_1_01", "wd-convnext-v3", "wd-swinv2-v3", "wd-vit-v3", "wd14-convnextv2-v2", "wd14-swinv2-v2", "wd14-vit-v2", "wd14-moat-v2", "wd-eva02-large-tagger-v3", "wd-vit-large-tagger-v3", "eva02_large_E621_FULL_V1"]).default("wd14-convnextv2-v2").description("Tagger 模型"),
